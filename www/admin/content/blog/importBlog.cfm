...
<cfif form.submitted>
	...
	<!--- Read Spreadsheet --->
    <cfspreadsheet action="read" src="#cffile.serverDirectory#/#ccfile.serverFile#" query="importData" headerRow="1" excludeHeaderRow="true" />
    ...
    <cfloop query="importData">
        ...
        <cfset blogPost.dateposted = importData['Date Post'] />
